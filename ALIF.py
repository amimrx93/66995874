...
while attemps < 12345677901:
    ...
    if username =='Delete' and password == '420':
...
def fuck():
    ...
    print(' [+] OK Ids saved in RAKIB /OK.txt')
...
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[RAKIB ]--[%s/%s]--[CP%s]~[OK-%s] \r'%(loop,tl,len(cps),len(oks))),
            sys.stdout.flush()
